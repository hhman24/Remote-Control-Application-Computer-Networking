...
class Keylogger_UI(Frame):
    def __init__(self, parent,client):    
        ...
        self.button_hook = Button(self, text = 'HOOK', width = 20, height = 5, fg = '#e64040', bg = '#4d4d4d',
            borderwidth=0,
            highlightthickness=0,
        ...
        self.button_lock = Button(self, text = 'LOCK', width = 20, height = 5, fg = '#e64040', bg = '#4d4d4d',
            borderwidth=0,
            highlightthickness=0,
            font='Helvetica 15 bold',
        ...
        self.button_print = Button(self, text = 'PRINT', width = 20, height = 5, fg = '#e64040', bg = '#4d4d4d',
            borderwidth=0,
            highlightthickness=0,
            font='Helvetica 15 bold',
        ...
        self.button_delete = Button(self, text = 'DELETE', width = 20, height = 5, fg = '#e64040', bg = '#4d4d4d',
            borderwidth=0,
            highlightthickness=0,
            font='Helvetica 15 bold',
        ...
        self.button_back = Button(self, text = 'BACK', width = 20, height = 5, fg = '#e64040', bg = '#4d4d4d',
            borderwidth=0,
            highlightthickness=0,
            font='Helvetica 15 bold',
            command= back,
